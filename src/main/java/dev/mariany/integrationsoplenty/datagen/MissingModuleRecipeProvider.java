...
public abstract class MissingModuleRecipeProvider extends FabricRecipeProvider {
    private final Module module;

    public MissingModuleRecipeProvider(
            Module module,
    ...
    protected final RecipeGenerator getRecipeGenerator(
        ...
        return this.createRecipeGenerator(
                registryLookup,
                this.withConditions(exporter, ResourceConditions.not(new ModuleResourceCondition(this.module)))
        );
    }
}
